                    ...
                    <div class="header">
                        <div class="header-content">
                            <div class="header-left">
                                <h1><span class="company-logo">🔐</span>Danh Sách Tài Khoản</h1>
                                <p>Quản lý tài khoản người dùng trong hệ thống</p>
                            </div>
                            <div class="header-right">
                                <div class="stat-badge">
                                    <span class="number">
                                        <xsl:value-of select="count(//TaiKhoan)"/>
                                    </span>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <xsl:for-each select="//TaiKhoan">
                                        <tr>
                                            <td><xsl:value-of select="MaTK"/></td>
                                            ...
                                            <td>
                                                <xsl:choose>
                                                    <xsl:when test="Quyen = 'Admin'">
                                                        <span class="quyen-admin">Admin</span>
                                                    </xsl:when>
                                                    <xsl:when test="Quyen = 'NhanVien'">
                                                        <span class="quyen-nhanvien">Nhân Viên</span>
                                                    </xsl:when>
                                                    <xsl:otherwise>

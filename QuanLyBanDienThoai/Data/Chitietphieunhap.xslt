                    ...
                    <div class="header">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <div class="info-value"><xsl:value-of select="//PhieuNhapInfo/MaPN"/></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Nhà Cung Cấp</div>
                                <div class="info-value"><xsl:value-of select="//PhieuNhapInfo/TenNCC"/></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Mã Nhân Viên</div>
                                <div class="info-value"><xsl:value-of select="//PhieuNhapInfo/MaNV"/></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">Ngày Nhập</div>
                                <div class="info-value">
                                    <xsl:variable name="dateStr" select="normalize-space(//PhieuNhapInfo/NgayNhap)"/>
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <xsl:value-of select="//PhieuNhapInfo/NgayNhap"/>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </div>
                            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="table-wrapper">
                            <table>
                                ...
                                <tbody>
                                    <xsl:variable name="total" select="sum(//ChiTietPhieuNhap/ThanhTien)"/>
                                    <xsl:for-each select="//ChiTietPhieuNhap">
                                        <tr>
                                            <td><xsl:value-of select="MaCTPN"/></td>
                                            <td>
                                                <span class="sp-code">
                                            ...
                                            <td class="text-right price-cell">
                                                <xsl:value-of select="format-number(DonGiaNhap, '#,##0')"/>
                                                <xsl:text> đ</xsl:text>
                                            </td>
                                            <td class="text-right price-cell">
                                    ...
                                    <tr class="total-row">
                                        ...
                                        <td class="text-right total-value">
                                            <xsl:value-of select="format-number(sum(//ChiTietPhieuNhap/ThanhTien), '#,##0')"/>
                                            <xsl:text> đ</xsl:text>
                                        </td>
                                    </tr>
                                </tbody>

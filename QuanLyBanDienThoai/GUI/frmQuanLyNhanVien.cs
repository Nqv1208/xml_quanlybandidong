...
namespace QuanLyBanDienThoai.GUI
{
    public partial class frmQuanLyNhanVien : Form
    {
        ...
        private string ConvertDataTableToHtml(DataTable dt)
        {
            ...
            html.AppendLine("    <title>Danh Sách Nhân Viên</title>");
            ...
            html.AppendLine("<h1>👥 DANH SÁCH NHÂN VIÊN</h1>");
            html.AppendLine($"<p>Xuất ngày: {DateTime.Now:dd/MM/yyyy HH:mm:ss} | Tổng số: {dt.Rows.Count} nhân viên</p>");
            html.AppendLine("</div>");
